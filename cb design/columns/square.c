...
{//start main
    ...
    float p,b,d,mux,muy,efc,ul,ac,as,fck,fy,n1,asp1,asp2,asp3,asp4,asp5,asmin,aspc,asmax,ad,nb,cc,nd,sd,sb,ag,ps,el,gpsfck,gps,efcd,x,y,mut,graph,asp,actp,agpsfck,smux1,mux1,muy1,puz;
    float ex,ey,exmin,eymin,pd,diatc,diat,plt,plt1,plt2,plt3,pltf,nob,nod,scb,scd,ppuz,alphan,ir,muxmuy;
	printf("<--------------YOU ARE SELECTED SQUARE COLUMN------------->\n");
					...
					{//start switch bd
    	                        ...
    	                        case 2:
    	                        {
					              ...
					              d=b=ag1;
					              printf("--------cross section of column--------\nb:%f\nd:%f\n",b,d);
				                  break;
				               }
			    	}//end switch bd
                    exmin=0.05*d;
		                     ...
		                     if(as<=0)
		                       ...
		                       if(sd>40&&sb>40)
						           {//start sd if
			                        ...
			                        printf("value of efcd:%f\n",efcd);
			                        printf("value of fy:%f and d'/d':%f\n",fy,efcd);
			                        printf("enter the mux1/fck*b*(d*d) from graph:");
			                        scanf("%f",&smux1);
